  ...
  describe('Token Data', () => {
    ...
    it('should return historic data for token FOX', async () => {
      const mock = {
        ...
        untrackedVolumeUSD: new BigNumber(
          '76.30795377259072457282647504828243'
        ),
    ...
    it('should return 1 token pool - 0xf5d990c5e284d2b4dee8473048ec869032f5a3b2', async () => {
      ...
      expect(pool.address).toEqual(
        '0x6f780226518a05c7d523e27fda2923ed80a6bae6'
      );
  ...
  describe('Pool Data', () => {
    ...
    it('should return past pool data for PBAYC', async () => {
      const poolsData = await service.getPoolsPastData(
        ['0x2aeb4cb9a9bff48cdeef591af1d63d8ee0b8bb6d'],
        13921672
      );
      ...
      expect(poolData.token0Price.toString()).toEqual(
        '408035.0863471973987418891045115962'
      );
      expect(poolData.token1Price.toString()).toEqual(
        '0.000002450769635896211036864679914811175'
      );
      expect(poolData.totalValueLockedToken0.toString()).toEqual(
        '8315.235280813108477741'
      );
    ...
    it('should return past day data for LP of PBAYC vault', async () => {
      ...
      const poolData1 = poolsData.find(
        (i: PoolDayData) => i.date === 1640995200
      );
      const poolData2 = poolsData.find(
        (i: PoolDayData) => i.date === 1640822400
      );
      const poolData3 = poolsData.find(
        (i: PoolDayData) => i.date === 1640736000
      );
      //
