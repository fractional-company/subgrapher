...
describe('SushiswapV1 integration tests', () => {
  ...
  describe('Token Data', () => {
    ...
    it('should return no token data - 0xe356025459d8222b068c474d50d93933f7316610', async () => {
      const token = await service.getTokenData(
        '0xe356025459d8222b068c474d50d93933f7316611'
      );
  ...
  describe('Pool Data', () => {
    ...
    it('should return past day data for LP of DOG vault', async () => {
      ...
      const poolData1 = poolsData.find(
        (i: PoolDayData) => i.date === 1632355200
      );
      const poolData2 = poolsData.find(
        (i: PoolDayData) => i.date === 1632268800
      );
      const poolData3 = poolsData.find(
        (i: PoolDayData) => i.date === 1632182400
      );
      //
